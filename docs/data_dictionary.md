...
The baseline code documents its expected columns directly in `src/explanation_faithfulness_aied/core.py` and `src/explanation_faithfulness_aied/synthetic.py`. This keeps the schema close to the executable logic.
